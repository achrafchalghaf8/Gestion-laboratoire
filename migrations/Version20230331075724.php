 ...
 */
final class Version20230331075724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chercheur CHANGE nom_prenom_id compte_id INT DEFAULT NULL, CHANGE nomprenom nom_prenom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE chercheur CHANGE compte_id nom_prenom_id INT DEFAULT NULL, CHANGE nom_prenom nomprenom VARCHAR(255) NOT NULL');
