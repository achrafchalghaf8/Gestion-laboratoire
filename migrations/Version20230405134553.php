 ...
 */
final class Version20230405134553 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chercheur_projet (chercheur_id INT NOT NULL, projet_id INT NOT NULL, INDEX IDX_414D615DC18272 (projet_id), INDEX IDX_414D615DF0950B34 (chercheur_id), PRIMARY KEY(chercheur_id, projet_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
