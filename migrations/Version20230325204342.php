 ...
 */
final class Version20230325204342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD chercheurs_id INT DEFAULT NULL, DROP auteur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD auteur VARCHAR(255) NOT NULL, DROP chercheurs_id');
    }
}
