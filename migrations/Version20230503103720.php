 ...
 */
final class Version20230503103720 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication_chercheur (publication_id INT NOT NULL, chercheur_id INT NOT NULL, INDEX IDX_81919DC7F0950B34 (chercheur_id), INDEX IDX_81919DC738B217A7 (publication_id), PRIMARY KEY(publication_id, chercheur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
